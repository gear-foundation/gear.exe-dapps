...
//const VARA_ETH_RPC = process.env.VARA_ETH_RPC! as "http://";
...
async function readResult(
  ...
  console.log('Probabilities: ', decoded);
  return decoded;
}
...
async function main() {
  ...
  if (MODE === 'predict') {
    const sails = await initSails(PROGRAM_ID);
    const payload = "";
    await sendInjectedTx(api, PROGRAM_ID, payload);
    await wait1Block();
    await readResult(sails, api, ethereumClient, PROGRAM_ID);
    return;
  }
